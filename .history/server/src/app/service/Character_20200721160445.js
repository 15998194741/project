...
class CharacterService{
	...
	static tosql(dict){
		let { between, inArray, ArrayIn, data } = dict;
		let where = '';
		where += between?CharacterService.byBetween(between):'';
		where += inArray?CharacterService.byBetween(inArray):'';
		where += ArrayIn?CharacterService.byBetween(ArrayIn):'';
		where += data?CharacterService.byBetween(data):'';
