...
class CharacterService{
	...
	async prohibitedMute(data){
		let {account_id, distinct_id, gameid, roleid, role_name, plaform, channel, machine, serverid, level, vip_level, sum_recharge, ip, regtime, update_time, servername} = data;
