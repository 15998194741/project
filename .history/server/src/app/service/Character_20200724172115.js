...
class CharacterService{
	...
	async outputConsume(data){
		...
		let sql = `select roleid,object_id,object_method,object_name,object_type,object_number from ${tablename} where roleid='${roleid}' ${object_type?`where object_type = '${object_type}'`:''}   offset ${pagesize} limit ${page}`;
		console.log(sql);
		return 11;
	}
