...
class CharacterService{
	...
	async prohibitedMute(data){
		...
		for(let i of data.value){
			...
			dbSequelize.query('insert into  gm_character (account_id, distinct_id,  roleid, role_name, plaform, channel, machine, serverid, level, vip_level, sum_recharge, ip, regtime, update_time, servername)values()');
		}
