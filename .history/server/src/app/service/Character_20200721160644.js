...
class CharacterService{
	...
	static tosql(dict){
		...
		condition += inArray?CharacterService.byBetween(inArray):'';
		condition += ArrayIn?CharacterService.byBetween(ArrayIn):'';
		condition += data?CharacterService.byBetween(data):'';
		let res = await +many === '1'?CharacterService.byOne(condition):CharacterService.byMany(condition);
