...
class CharacterService{
	...
	async outputConsume(data){
		...
		let sql = `select roleid,object_id,object_method,object_name,object_type,object_number,timestamp from ${tablename} where roleid='${roleid}'    offset ${pagesize*(page-1)} limit ${pagesize}`;
