<template>
  <div class="recha-container">
    ...
    <ul>
      ...
      <li><el-button slot="reference" style="margin: 5px 5px -3px 0 ;" icon="el-icon-refresh" size='small' class="button-with-header"  @click="filterFormChange">刷新</el-button></li>
  ...
  <div class="role-container-search">
    ...
    <div class="comprehensive-container">
      <div v-for='(i,index) in selectForm' :key='index'  class="select-item"  > {{i.label}}:
        <el-select v-model="filterForm[i.key]" :multiple="i['multiple']" placeholder="请选择" size='small' style="border-radius: 10px;" @change="filterFormChange" >
...
export default {
  ...
  methods: {
    async filterFormChange(methods, one, two, there) {
      console.log(methods, one, two, there);
    },
