<template>
  <div class="recha-container">
    ...
    <ul>
      ...
      <li> <el-button  slot="append" icon="el-icon-delete-solid" size='small' class="button-with-header" :disabled='fenghaocaozuo' >补单</el-button></li>
    </ul>
  </div>
  ...
  data() {
    return {
      ...
      tablecolumn: [
        ...
        { label: '设备ID', prop: 'plaform', width: -50 },
        { label: '设备类型', prop: 'plaform', width: -50 },
        { label: '区服ID', prop: 'plaform', width: -50 },
        { label: '充值金额', prop: 'plaform', width: -50 },
        { label: '商品ID', prop: 'plaform', width: -50 },
        { label: '订单状态', prop: 'plaform', width: -50 },
        { label: '订单号', prop: 'plaform', width: -50 },
        { label: '下单事件', prop: 'plaform', width: -50 },
        { label: '到账时间', prop: 'plaform', width: -50 },
        { label: '错误信息', prop: 'plaform', width: -50 }
