...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      tablecolumn: [
        { label: '角色ID', prop: 'roleid', width: 0 },
        { label: '账户ID', prop: 'account_id', width: 0 },
        { label: '昵称', prop: 'role_name', width: 0 },
        { label: '平台', prop: 'plaform', width: 0 },
        { label: '客户端', prop: 'plaform', width: 0 },
        { label: '设备ID', prop: 'plaform', width: 0 },
        { label: '设备类型', prop: 'plaform', width: 0 },
        { label: '区服ID', prop: 'plaform', width: 0 },
        { label: '充值金额', prop: 'plaform', width: 0 },
        { label: '商品ID', prop: 'plaform', width: 0 },
        { label: '订单状态', prop: 'plaform', width: 0 },
        { label: '订单号', prop: 'plaform', width: 0 },
        { label: '下单时间', prop: 'plaform', width: 0 },
        { label: '到账时间', prop: 'plaform', width: 0 },
        { label: '错误信息', prop: 'plaform', width: 0 }
      ],
      screenWidth: 145
    };
