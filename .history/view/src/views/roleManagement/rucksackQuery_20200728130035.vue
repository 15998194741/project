...
export default {
  ...
  methods: {
    recycleAmountChange(index, data) {
      let string = this.allselectchange[index].recycleAmount;
      ...
      string.replace(/\b(0+)/gi, '');
      this.allselectchange[index].recycleAmount = string;
      let a = /([0-9]*)(.*)$/;
      this.allselectchange[index].recycleAmount.replace(a, '$1');
    },
