    ...
    exportFile() {
      require.ensure([], () => {
        ...
        for (let i of this.tableTrue) {
          list.push([i.roleid, i.account_id, i.role_name, i.plaform, i.channel, i.distinct_id, i.machine, i.servername, i.serverid, i.level, i.vip_level, i.ip, i.regtime, i.update_time, i.banned_type, i.banned_area, i.banned_reason, i.banned_time, i.stime_etime]);
        }
        console.log(list);
