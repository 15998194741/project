<template>
  ...
  <div id='body' class="role-container-body">
    ...
    <el-table-column v-for='(column,index) in tablecolumn' :key='index' :width="index==='serverid'?screenWidth:screenWidth" :label="column.label">
...
export default {
  ...
  data() {
    return {
      ...
      tablecolumn: [
        { label: '角色ID', prop: 'roleid', width: -5 },
        { label: '账户ID', prop: 'account_id', width: -5 },
        { label: '昵称', prop: 'role_name', width: -5 },
        { label: '平台', prop: 'palform', width: -5 },
        { label: '客户端', prop: 'channel', width: -5 },
        { label: '设备ID', prop: 'distinct_id', width: -5 },
        { label: '设备类型', prop: 'machine', width: -5 },
        { label: '区服名称', prop: 'vip_level', width: -5 },
        { label: '区服ID', prop: 'serverid', width: 5 },
        { label: '等级', prop: 'level', width: -5 },
        { label: 'VIP等级', prop: 'vip_level', width: -5 }
