...
页码{{screenWidth}}--{{screenHeight}}
  ...
  <el-dialog title="文件上传" :visible.sync="serverCreatedialogFormVisible"  :close-on-click-modal="false">
    <div><input id="file"  type="file" name="file" accept=".xlsx,.xls" >
      <span class="add-file-right-more">支持扩展名：.xlsx .xls </span></div>
   
   <div><el-button @click="serverCreatedialogFormVisible = false">取 消</el-button></el-dialog>
