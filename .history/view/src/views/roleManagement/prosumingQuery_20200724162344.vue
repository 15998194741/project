<template>
  ...
  <div class="role-container-search">
    <div class="server-container"> 
      <el-radio v-model="filterForm" label="1">产出查询</el-radio>
      <el-radio v-model="filterForm" label="1">不限制</el-radio>

      <el-radio v-model="radio" label="0">消耗查询</el-radio>
      ID：
...
export default {
  ...
  mounted() {
    ...
    erd.listenTo(document.getElementById('body'), element =>{
      this.screenWidth = element.offsetWidth * 0.1617647058823529348;
