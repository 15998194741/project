    ...
    <div class="alertname">
      <el-table ref="multipleTable" :data="allselectchange">
        ...
        <el-table-column  label="回收数量" >
          <template slot-scope="scope"><el-input v-model="scope.row.recycleAmount" :value="scope.row.articleAmount" type='number'    placeholder="请输入内容"  @input="recycleAmountChange(scope.$index,scope.row)"></el-input></template>
        </el-table-column>
      </el-table>
    </div>
