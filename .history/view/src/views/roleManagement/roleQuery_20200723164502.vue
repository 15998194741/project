  ...
  <el-dialog title="封号操作" :visible.sync="dialogFormchange"  :close-on-click-modal="false">
    ...
    <div slot="footer" class="dialog-footer">
      <el-form ref="createForm" :rules="createFormRules" :model="createForm" label-width="100px"  class='createFormAlert'> 
        ...
        <el-form-item label="封禁范围" class="createFormAlertBody" prop='servername' hide-required-asterisk required>
          <el-select  class="alertcontant" multiple placeholder="请选择客户端">
        ...
        <el-form-item label="封禁原因" class="createFormAlertBody"  prop='plaform' hide-required-asterisk required>
        ...
        <el-form-item label="封禁时长" class="createFormAlertBody"  prop='channel' hide-required-asterisk required>
