  ...
  data() {
    return {
      ...
      tablecolumn: [
        ...
        { label: '平台', prop: 'palform', width: 0 },
        { label: '客户端', prop: 'channel', width: 0 },
        { label: '设备ID', prop: 'distinct_id', width: 0 },
        { label: '设备类型', prop: 'machine', width: -50 },
        { label: '区服名称', prop: 'vip_level', width: -5 },
        { label: '区服ID', prop: 'serverid', width: 50 },
