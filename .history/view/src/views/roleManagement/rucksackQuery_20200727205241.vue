  ...
  <el-dialog title="批量操作" :visible.sync="dialogFormchange"  :close-on-click-modal="false">
    ...
    <div class="alertname">
      <el-table ref="multipleTable" :data="allselectchange">
        <el-table-column prop='pid' label="物品ID" :width="widthtable">
        </el-table-column>
        <el-table-column prop="serverid" label="物品名称" :width="widthtable">
        </el-table-column>
        <el-table-column prop="servername" label="物品类型" :width="widthtable">
        </el-table-column>
        <el-table-column prop="plaform" label="持有数量" :width="widthtable">
        </el-table-column>
