...
页码{{screenWidth}}--{{screenHeight}}
  ...
  name='file'
  :headers='headers'
  action="http://localhost:8080/api/character/uploadFile"
  accept='.xlsx,.xls'>
  <i class="el-icon-upload"></i>
  <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
  <div slot="tip" class="el-upload__tip">只能上传xlsx/xls文件，且不超过500kb</div>
</el-upload>
   <div><el-button @click="serverCreatedialogFormVisible = false">取 消</el-button></div>
...
import { queryCharacter, findServername } from '@/api/character.js';
export default {
  ...
  data() {
    return {
      ...
      file: '',
      headers: {
        'fancy-guo-login-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BtDlkV5MPKnTCUamUgH__GASdJn3_GIoY57lWbrdujE',
