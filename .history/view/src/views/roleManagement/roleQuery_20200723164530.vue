<template>
  <div class="role-container">
    ...
    <ul>
      ...
      <li> <el-button  slot="append" icon="el-icon-circle-plus-outline" size='small' class="button-with-header" @click='dialogFormchange = true'>封号禁言</el-button></li>
    </ul>
  </div>
 ...
 >
  ...
  <el-dialog title="封号操作" :visible.sync="dialogFormchange"  :close-on-click-modal="false">
    ...
    <div slot="footer" class="dialog-footer">
      <el-form ref="createForm"  label-width="100px"  class='createFormAlert'> 
        <el-form-item label="封禁类型" class="createFormAlertBody" >
          <el-select  class="alertcontant" multiple placeholder="请选择客户端">
            <el-option  label='封号' :value="value"></el-option>
              <el-option  label='禁言' :value="value">
            </el-option>     
          </el-select>
        </el-form-item>
        <el-form-item label="封禁范围" class="createFormAlertBody"  hide-required-asterisk required>
          <el-select  class="alertcontant" multiple placeholder="请选择客户端">
            <el-option  label='角色' :value="value"></el-option>
              <el-option  label='账户' :value="value"></el-option>
                <el-option  label='IP' :value="value">

            </el-option>     
          </el-select>
        </el-form-item>
        <el-form-item label="封禁原因" class="createFormAlertBody"   hide-required-asterisk required>
        ...
        <el-form-item label="封禁时长" class="createFormAlertBody"  hide-required-asterisk required>
        </el-form-item>
</el-form>     
...
import { queryCharacter, findServername, readfile } from '@/api/character.js';
export default {
