    ...
    <div slot="footer" class="dialog-footer">
      <el-form ref="createForm"  label-width="100px"  class='createFormAlert'> 
        ...
        <el-form-item label="封禁范围" class="createFormAlertBody"  hide-required-asterisk required>
          <el-select  v-model='insertForm.area' class="alertcontant"  placeholder="请选择客户端">
        ...
        <el-form-item label="封禁时长" class="createFormAlertBodys"  hide-required-asterisk required>
          <el-input v-model="input" placeholder="请输入内容"></el-input>
          <el-select  v-model='insertForm.time' class="alertcontant"  placeholder="请选择客户端">
...
.role-container{
  ...
  .server-container {
    ...
    .createFormAlertBodys div:first-child{
      display: flex;
    }
